...
if ($result->num_rows > 0) {
    echo "<table><tr><th>slno</th><th>Date</th><th>Name of expense</th><th>Type of expense</th><th>Amount</th><th><i class='fa fa-pencil'></i></th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["slno"]. "</td><td>" . $row["date"]. "</td><td>" . $row["name of expense"]. "</td><td>" . $row["type of expense"]. "</td><td>" . $row["amount"]. "</td>
        <td><a href='editform.php?slno=".$row['slno']."'>Edit</a></td></tr>";
    }
    echo "</table>";
} else {
    echo "0 results";
